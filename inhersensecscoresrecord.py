...
class SenSecScoresRecord(QWidget):
    def __init__(self):
        ...
        self.ui.qur_score_btn.clicked.connect(self.saveBiologyScores)
        self.ui.qur_score_btn.clicked.connect(self.saveChemistryScores)
        self.ui.qur_score_btn.clicked.connect(self.saveFurtherScores)
        self.ui.qur_score_btn.clicked.connect(self.savePhysicsScores)
        ...
        self.ui.qur_score_btn.clicked.connect(self.saveGeographyScores)
        self.ui.qur_score_btn.clicked.connect(self.saveEconsScores)
    ...
    def displaySpinVals(self):
        ...
        self.ui.biology_c1_spin.setValue(0)
        self.ui.biology_c2_spin.setValue(0)
        self.ui.biology_ass_spin.setValue(0)
        self.ui.biology_att_spin.setValue(0)
        self.ui.biology_exam_spin.setValue(0)
        ...
        self.ui.geography_c1_spin.setValue(0)
        self.ui.geography_c2_spin.setValue(0)
        self.ui.geography_ass_spin.setValue(0)
        self.ui.geography_att_spin.setValue(0)
        self.ui.geography_exam_spin.setValue(0)
        self.ui.econs_c1_spin.setValue(0)
        self.ui.econs_c2_spin.setValue(0)
        self.ui.econs_ass_spin.setValue(0)
        self.ui.econs_att_spin.setValue(0)
        self.ui.econs_exam_spin.setValue(0)
        ...
        try:
            cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
            ...
            if row != None and row[15] != None and row[16] != None and row[17] != None and row[18] != None and row[19] != None:
                self.ui.civic_c1_spin.setValue(row[15])
                self.ui.civic_c2_spin.setValue(row[16])
                self.ui.civic_ass_spin.setValue(row[17])
                self.ui.civic_att_spin.setValue(row[18])
                self.ui.civic_exam_spin.setValue(row[19])
            if row != None and row[21] != None and row[22] != None and row[23] != None and row[24] != None and row[25] != None:
                self.ui.computer_c1_spin.setValue(row[21])
                self.ui.computer_c2_spin.setValue(row[22])
                self.ui.computer_ass_spin.setValue(row[23])
                self.ui.computer_att_spin.setValue(row[24])
                self.ui.computer_exam_spin.setValue(row[25])
            if row != None and row[27] != None and row[28] != None and row[29] != None and row[30] != None and row[31] != None:
                self.ui.biology_c1_spin.setValue(row[27])
                self.ui.biology_c2_spin.setValue(row[28])
                self.ui.biology_ass_spin.setValue(row[29])
                self.ui.biology_att_spin.setValue(row[30])
                self.ui.biology_exam_spin.setValue(row[31])
            if row != None and row[33] != None and row[34] != None and row[35] != None and row[36] != None and row[37] != None:
                self.ui.chemistry_c1_spin.setValue(row[33])
                self.ui.chemistry_c2_spin.setValue(row[34])
                self.ui.chemistry_ass_spin.setValue(row[35])
                self.ui.chemistry_att_spin.setValue(row[36])
                self.ui.chemistry_exam_spin.setValue(row[37])
            if row != None and row[39] != None and row[40] != None and row[41] != None and row[42] != None and row[43] != None:
                self.ui.further_c1_spin.setValue(row[39])
                self.ui.further_c2_spin.setValue(row[40])
                self.ui.further_ass_spin.setValue(row[41])
                self.ui.further_att_spin.setValue(row[42])
                self.ui.further_exam_spin.setValue(row[43])
            if row != None and row[45] != None and row[46] != None and row[47] != None and row[48] != None and row[49] != None:
                self.ui.physics_c1_spin.setValue(row[45])
                self.ui.physics_c2_spin.setValue(row[46])
                self.ui.physics_ass_spin.setValue(row[47])
                self.ui.physics_att_spin.setValue(row[48])
                self.ui.physics_exam_spin.setValue(row[49])
            if row != None and row[51] != None and row[52] != None and row[53] != None and row[54] != None and row[55] != None:
                self.ui.qur_c1_spin.setValue(row[51])
                self.ui.qur_c2_spin.setValue(row[52])
                self.ui.qur_ass_spin.setValue(row[53])
                self.ui.qur_att_spin.setValue(row[54])
                self.ui.qur_exam_spin.setValue(row[55])
            if row != None and row[57] != None and row[58] != None and row[59] != None and row[60] != None and row[61] != None:
                self.ui.irs_c1_spin.setValue(row[57])
                self.ui.irs_c2_spin.setValue(row[58])
                self.ui.irs_ass_spin.setValue(row[59])
                self.ui.irs_att_spin.setValue(row[60])
                self.ui.irs_exam_spin.setValue(row[61])
            if row != None and row[63] != None and row[64] != None and row[65] != None and row[66] != None and row[67] != None:
                self.ui.arabic_c1_spin.setValue(row[63])
                self.ui.arabic_c2_spin.setValue(row[64])
                self.ui.arabic_ass_spin.setValue(row[65])
                self.ui.arabic_att_spin.setValue(row[66])
                self.ui.arabic_exam_spin.setValue(row[67])
            if row != None and row[69] != None and row[70] != None and row[71] != None and row[72] != None and row[73] != None:
                self.ui.tajweed_c1_spin.setValue(row[69])
                self.ui.tajweed_c2_spin.setValue(row[70])
                self.ui.tajweed_ass_spin.setValue(row[71])
                self.ui.tajweed_att_spin.setValue(row[72])
                self.ui.tajweed_exam_spin.setValue(row[73])
            if row != None and row[75] != None and row[76] != None and row[77] != None and row[78] != None and row[79] != None:
                self.ui.agric_c1_spin.setValue(row[75])
                self.ui.agric_c2_spin.setValue(row[76])
                self.ui.agric_ass_spin.setValue(row[77])
                self.ui.agric_att_spin.setValue(row[78])
                self.ui.agric_exam_spin.setValue(row[79])
            if row != None and row[81] != None and row[82] != None and row[83] != None and row[84] != None and row[85] != None:
                self.ui.geography_c1_spin.setValue(row[81])
                self.ui.geography_c2_spin.setValue(row[82])
                self.ui.geography_ass_spin.setValue(row[83])
                self.ui.geography_att_spin.setValue(row[84])
                self.ui.geography_exam_spin.setValue(row[85])
            if row != None and row[87] != None and row[88] != None and row[89] != None and row[90] != None and row[91] != None:
                self.ui.econs_c1_spin.setValue(row[87])
                self.ui.econs_c2_spin.setValue(row[88])
                self.ui.econs_ass_spin.setValue(row[89])
                self.ui.econs_att_spin.setValue(row[90])
                self.ui.econs_exam_spin.setValue(row[91])
        except Error as e:
    ...
    def saveEnglishScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_att, eng_exam, eng_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_att, eng_exam, eng_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, eng_c1 = ?, eng_c2 = ?, eng_ass = ?, eng_att = ?, eng_exam = ?, eng_total  = ? WHERE stud_no = ?"
    ...
    def saveMathScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, math_c1, math_c2, math_ass, math_att, math_exam, math_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, math_c1, math_c2, math_ass, math_att, math_exam, math_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, math_c1 = ?, math_c2 = ?, math_ass = ?, math_att = ?, math_exam = ?, math_total  = ? WHERE stud_no = ?"
    ...
    def saveCivicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_att, civic_exam, civic_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_att, civic_exam, civic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, civic_c1 = ?, civic_c2 = ?, civic_ass = ?, civic_att = ?, civic_exam = ?, civic_total  = ? WHERE stud_no = ?"
    ...
    def saveComputerScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, computer_c1, computer_c2, computer_ass, computer_att, computer_exam, computer_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, computer_c1, computer_c2, computer_ass, computer_att, computer_exam, computer_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, computer_c1 = ?, computer_c2 = ?, computer_ass = ?, computer_att = ?, computer_exam = ?, computer_total  = ? WHERE stud_no = ?"
    ...
    def saveBiologyScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        biology_c1 = self.ui.biology_c1_spin.value()
        biology_c2 = self.ui.biology_c2_spin.value()
        biology_ass = self.ui.biology_ass_spin.value()
        biology_att = self.ui.biology_att_spin.value()
        biology_exam = self.ui.biology_exam_spin.value()
        biology_total = biology_c1 + biology_c2 + biology_ass + biology_att + biology_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, biology_c1, biology_c2, biology_ass, biology_att, biology_exam, biology_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, biology_c1, biology_c2, biology_ass, biology_att, biology_exam, biology_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, biology_c1 = ?, biology_c2 = ?, biology_ass = ?, biology_att = ?, biology_exam = ?, biology_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, biology_c1, biology_c2, biology_ass, biology_att, biology_exam, biology_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveChemistryScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        chemistry_c1 = self.ui.chemistry_c1_spin.value()
        chemistry_c2 = self.ui.chemistry_c2_spin.value()
        chemistry_ass = self.ui.chemistry_ass_spin.value()
        chemistry_att = self.ui.chemistry_att_spin.value()
        chemistry_exam = self.ui.chemistry_exam_spin.value()
        chemistry_total = chemistry_c1 + chemistry_c2 + chemistry_ass + chemistry_att + chemistry_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, chemistry_c1, chemistry_c2, chemistry_ass, chemistry_att, chemistry_exam, chemistry_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, chemistry_c1, chemistry_c2, chemistry_ass, chemistry_att, chemistry_exam, chemistry_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, chemistry_c1 = ?, chemistry_c2 = ?, chemistry_ass = ?, chemistry_att = ?, chemistry_exam = ?, chemistry_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, chemistry_c1, chemistry_c2, chemistry_ass, chemistry_att, chemistry_exam, chemistry_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveFurtherScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        further_c1 = self.ui.further_c1_spin.value()
        further_c2 = self.ui.further_c2_spin.value()
        further_ass = self.ui.further_ass_spin.value()
        further_att = self.ui.further_att_spin.value()
        further_exam = self.ui.further_exam_spin.value()
        further_total = further_c1 + further_c2 + further_ass + further_att + further_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, further_c1, further_c2, further_ass, further_att, further_exam, further_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, further_c1, further_c2, further_ass, further_att, further_exam, further_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, further_c1 = ?, further_c2 = ?, further_ass = ?, further_att = ?, further_exam = ?, further_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, further_c1, further_c2, further_ass, further_att, further_exam, further_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def savePhysicsScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        physics_c1 = self.ui.physics_c1_spin.value()
        physics_c2 = self.ui.physics_c2_spin.value()
        physics_ass = self.ui.physics_ass_spin.value()
        physics_att = self.ui.physics_att_spin.value()
        physics_exam = self.ui.physics_exam_spin.value()
        physics_total = physics_c1 + physics_c2 + physics_ass + physics_att + physics_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, physics_c1, physics_c2, physics_ass, physics_att, physics_exam, physics_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, physics_c1, physics_c2, physics_ass, physics_att, physics_exam, physics_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, physics_c1 = ?, physics_c2 = ?, physics_ass = ?, physics_att = ?, physics_exam = ?, physics_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, physics_c1, physics_c2, physics_ass, physics_att, physics_exam, physics_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveQurScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_att, qur_exam, qur_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_att, qur_exam, qur_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, qur_c1 = ?, qur_c2 = ?, qur_ass = ?, qur_att = ?, qur_exam = ?, qur_total  = ? WHERE stud_no = ?"
    ...
    def saveIrsScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, irs_c1, irs_c2, irs_ass, irs_att, irs_exam, irs_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, irs_c1, irs_c2, irs_ass, irs_att, irs_exam, irs_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, irs_c1 = ?, irs_c2 = ?, irs_ass = ?, irs_att = ?, irs_exam = ?, irs_total  = ? WHERE stud_no = ?"
    ...
    def saveArabicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, arabic_c1, arabic_c2, arabic_ass, arabic_att, arabic_exam, arabic_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, arabic_c1, arabic_c2, arabic_ass, arabic_att, arabic_exam, arabic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, arabic_c1 = ?, arabic_c2 = ?, arabic_ass = ?, arabic_att = ?, arabic_exam = ?, arabic_total  = ? WHERE stud_no = ?"
    ...
    def saveTajweedScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, tajweed_c1, tajweed_c2, tajweed_ass, tajweed_att, tajweed_exam, tajweed_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, tajweed_c1, tajweed_c2, tajweed_ass, tajweed_att, tajweed_exam, tajweed_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, tajweed_c1 = ?, tajweed_c2 = ?, tajweed_ass = ?, tajweed_att = ?, tajweed_exam = ?, tajweed_total  = ? WHERE stud_no = ?"
    ...
    def saveAgricScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, agric_c1, agric_c2, agric_ass, agric_att, agric_exam, agric_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, agric_c1, agric_c2, agric_ass, agric_att, agric_exam, agric_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, agric_c1 = ?, agric_c2 = ?, agric_ass = ?, agric_att = ?, agric_exam = ?, agric_total  = ? WHERE stud_no = ?"
    ...
    def saveGeographyScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        geography_c1 = self.ui.geography_c1_spin.value()
        geography_c2 = self.ui.geography_c2_spin.value()
        geography_ass = self.ui.geography_ass_spin.value()
        geography_att = self.ui.geography_att_spin.value()
        geography_exam = self.ui.geography_exam_spin.value()
        geography_total = geography_c1 + geography_c2 + geography_ass + geography_att + geography_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, geography_c1, geography_c2, geography_ass, geography_att, geography_exam, geography_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, geography_c1, geography_c2, geography_ass, geography_att, geography_exam, geography_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, geography_c1 = ?, geography_c2 = ?, geography_ass = ?, geography_att = ?, geography_exam = ?, geography_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, geography_c1, geography_c2, geography_ass, geography_att, geography_exam, geography_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveEconsScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        econs_c1 = self.ui.econs_c1_spin.value()
        econs_c2 = self.ui.econs_c2_spin.value()
        econs_ass = self.ui.econs_ass_spin.value()
        econs_att = self.ui.econs_att_spin.value()
        econs_exam = self.ui.econs_exam_spin.value()
        econs_total = econs_c1 + econs_c2 + econs_ass + econs_att + econs_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_first(stud_no, score_class, econs_c1, econs_c2, econs_ass, econs_att, econs_exam, econs_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, econs_c1, econs_c2, econs_ass, econs_att, econs_exam, econs_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, score_class = ?, econs_c1 = ?, econs_c2 = ?, econs_ass = ?, econs_att = ?, econs_exam = ?, econs_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, econs_c1, econs_c2, econs_ass, econs_att, econs_exam, econs_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            pass
        elif row[8] != None and row[14] != None and row[20] != None and row[26] != None and row[32] != None and row[38] != None and row[44] != None and row[50] != None and row[56] != None and row[62] != None and row[68] != None and row[74] != None and row[80] != None and row[86] != None and row[92] != None:
            try:
                all_total = row[8] + row[14] + row[20] + row[26] + row[32] + row[38] + row[44] + row[50] + row[56] + row[62] + row[68] + row[74] + row[80] + row[86] + row[92]
                avg = round((all_total/15), 4)
                cmd2 = "UPDATE t_sen_sec_scores_first SET stud_no = ?, all_total = ?, avg = ?  WHERE stud_no = ?"
...
class SenSecScoresView(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_SenSecScoreForm()
        self.ui.setupUi(self)
        self.sec_report = SenSecReport()
        self.displayClasses()
    ...
    def displayClasses(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        query = cur.execute('SELECT * FROM t_sen_sec_scores_first ORDER BY score_class')
        self.ui.class_comboBox.clear()
        classes = ["Select a class"]
        rows = cur.fetchall()
        for row in rows:
    ...
    def listStudsScores(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        cmd = "SELECT * FROM t_sen_sec_scores_first ORDER BY stud_no"
        cur.execute(cmd)
        rows = cur.fetchall()
    ...
    def listClass(self):
        ...
        cur = con.cursor()
        classes_combo = self.ui.class_comboBox.currentText()
        cmd = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY stud_no"
        cur.execute(cmd, (classes_combo,))
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
    ...
    def deleteStud(self):
        ...
        if stud_no == "Select an admission number":
            ...
            cmd = "DELETE FROM t_sen_sec_scores_first WHERE stud_no = ?"
    ...
    def generateSecReport(self):
        ...
        if row == None:
            ...
            try:
                cmd3 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
                ...
                self.sec_report.ui.civic_c1_label.setText(str(row[15]))
                self.sec_report.ui.civic_c2_label.setText(str(row[16]))
                self.sec_report.ui.civic_ass_label.setText(str(row[17]))
                self.sec_report.ui.civic_att_label.setText(str(row[18]))
                self.sec_report.ui.civic_exam_label.setText(str(row[19]))
                self.sec_report.ui.civic_total_label.setText(str(row[20]))
                if row[20] < 40:
                ...
                self.sec_report.ui.computer_c1_label.setText(str(row[21]))
                self.sec_report.ui.computer_c2_label.setText(str(row[22]))
                self.sec_report.ui.computer_ass_label.setText(str(row[23]))
                self.sec_report.ui.computer_att_label.setText(str(row[24]))
                self.sec_report.ui.computer_exam_label.setText(str(row[25]))
                self.sec_report.ui.computer_total_label.setText(str(row[26]))
                if row[26] < 40:
                ...
                self.sec_report.ui.biology_c1_label.setText(str(row[27]))
                self.sec_report.ui.biology_c2_label.setText(str(row[28]))
                self.sec_report.ui.biology_ass_label.setText(str(row[29]))
                self.sec_report.ui.biology_att_label.setText(str(row[30]))
                self.sec_report.ui.biology_exam_label.setText(str(row[31]))
                self.sec_report.ui.biology_total_label.setText(str(row[32]))
                if row[32] < 40:
                    self.sec_report.ui.biology_grade_label.setText("F")
                    self.sec_report.ui.biology_remark_label.setText("Fail")
                elif row[32] >= 40 and row[32] < 46:
                    self.sec_report.ui.biology_grade_label.setText("E")
                    self.sec_report.ui.biology_remark_label.setText("Pass")
                elif row[32] >= 46 and row[32] < 50:
                    self.sec_report.ui.biology_grade_label.setText("D")
                    self.sec_report.ui.biology_remark_label.setText("Pass")
                elif row[32] >= 50 and row[32] < 60:
                    self.sec_report.ui.biology_grade_label.setText("C")
                    self.sec_report.ui.biology_remark_label.setText("Good")
                elif row[32] >= 60 and row[32] < 70:
                    self.sec_report.ui.biology_grade_label.setText("B")
                    self.sec_report.ui.biology_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.biology_grade_label.setText("A")
                    self.sec_report.ui.biology_remark_label.setText("Excellent")
                self.sec_report.ui.chemistry_c1_label.setText(str(row[33]))
                self.sec_report.ui.chemistry_c2_label.setText(str(row[34]))
                self.sec_report.ui.chemistry_ass_label.setText(str(row[35]))
                self.sec_report.ui.chemistry_att_label.setText(str(row[36]))
                self.sec_report.ui.chemistry_exam_label.setText(str(row[37]))
                self.sec_report.ui.chemistry_total_label.setText(str(row[38]))
                if row[38] < 40:
                    self.sec_report.ui.chemistry_grade_label.setText("F")
                    self.sec_report.ui.chemistry_remark_label.setText("Fail")
                elif row[38] >= 40 and row[38] < 46:
                    self.sec_report.ui.chemistry_grade_label.setText("E")
                    self.sec_report.ui.chemistry_remark_label.setText("Pass")
                elif row[38] >= 46 and row[38] < 50:
                    self.sec_report.ui.chemistry_grade_label.setText("D")
                    self.sec_report.ui.chemistry_remark_label.setText("Pass")
                elif row[38] >= 50 and row[38] < 60:
                    self.sec_report.ui.chemistry_grade_label.setText("C")
                    self.sec_report.ui.chemistry_remark_label.setText("Good")
                elif row[38] >= 60 and row[38] < 70:
                    self.sec_report.ui.chemistry_grade_label.setText("B")
                    self.sec_report.ui.chemistry_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.chemistry_grade_label.setText("A")
                    self.sec_report.ui.chemistry_remark_label.setText("Excellent")
                self.sec_report.ui.further_c1_label.setText(str(row[39]))
                self.sec_report.ui.further_c2_label.setText(str(row[40]))
                self.sec_report.ui.further_ass_label.setText(str(row[41]))
                self.sec_report.ui.further_att_label.setText(str(row[42]))
                self.sec_report.ui.further_exam_label.setText(str(row[43]))
                self.sec_report.ui.further_total_label.setText(str(row[44]))
                if row[44] < 40:
                    self.sec_report.ui.further_grade_label.setText("F")
                    self.sec_report.ui.further_remark_label.setText("Fail")
                elif row[44] >= 40 and row[44] < 46:
                    self.sec_report.ui.further_grade_label.setText("E")
                    self.sec_report.ui.further_remark_label.setText("Pass")
                elif row[44] >= 46 and row[44] < 50:
                    self.sec_report.ui.further_grade_label.setText("D")
                    self.sec_report.ui.further_remark_label.setText("Pass")
                elif row[44] >= 50 and row[44] < 60:
                    self.sec_report.ui.further_grade_label.setText("C")
                    self.sec_report.ui.further_remark_label.setText("Good")
                elif row[44] >= 60 and row[44] < 70:
                    self.sec_report.ui.further_grade_label.setText("B")
                    self.sec_report.ui.further_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.further_grade_label.setText("A")
                    self.sec_report.ui.further_remark_label.setText("Excellent")
                self.sec_report.ui.physics_c1_label.setText(str(row[45]))
                self.sec_report.ui.physics_c2_label.setText(str(row[46]))
                self.sec_report.ui.physics_ass_label.setText(str(row[47]))
                self.sec_report.ui.physics_att_label.setText(str(row[48]))
                self.sec_report.ui.physics_exam_label.setText(str(row[49]))
                self.sec_report.ui.physics_total_label.setText(str(row[50]))
                if row[50] < 40:
                    self.sec_report.ui.physics_grade_label.setText("F")
                    self.sec_report.ui.physics_remark_label.setText("Fail")
                elif row[50] >= 40 and row[50] < 46:
                    self.sec_report.ui.physics_grade_label.setText("E")
                    self.sec_report.ui.physics_remark_label.setText("Pass")
                elif row[50] >= 46 and row[50] < 50:
                    self.sec_report.ui.physics_grade_label.setText("D")
                    self.sec_report.ui.physics_remark_label.setText("Pass")
                elif row[50] >= 50 and row[50] < 60:
                    self.sec_report.ui.physics_grade_label.setText("C")
                    self.sec_report.ui.physics_remark_label.setText("Good")
                elif row[50] >= 60 and row[50] < 70:
                    self.sec_report.ui.physics_grade_label.setText("B")
                    self.sec_report.ui.physics_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.physics_grade_label.setText("A")
                    self.sec_report.ui.physics_remark_label.setText("Excellent")
                self.sec_report.ui.qur_c1_label.setText(str(row[51]))
                self.sec_report.ui.qur_c2_label.setText(str(row[52]))
                self.sec_report.ui.qur_ass_label.setText(str(row[53]))
                self.sec_report.ui.qur_att_label.setText(str(row[54]))
                self.sec_report.ui.qur_exam_label.setText(str(row[55]))
                self.sec_report.ui.qur_total_label.setText(str(row[56]))
                if row[56] < 40:
                ...
                self.sec_report.ui.irs_c1_label.setText(str(row[57]))
                self.sec_report.ui.irs_c2_label.setText(str(row[58]))
                self.sec_report.ui.irs_ass_label.setText(str(row[59]))
                self.sec_report.ui.irs_att_label.setText(str(row[60]))
                self.sec_report.ui.irs_exam_label.setText(str(row[61]))
                self.sec_report.ui.irs_total_label.setText(str(row[62]))
                if row[62] < 40:
                ...
                self.sec_report.ui.arabic_c1_label.setText(str(row[63]))
                self.sec_report.ui.arabic_c2_label.setText(str(row[64]))
                self.sec_report.ui.arabic_ass_label.setText(str(row[65]))
                self.sec_report.ui.arabic_att_label.setText(str(row[66]))
                self.sec_report.ui.arabic_exam_label.setText(str(row[67]))
                self.sec_report.ui.arabic_total_label.setText(str(row[68]))
                if row[68] < 40:
                ...
                self.sec_report.ui.tajweed_c1_label.setText(str(row[69]))
                self.sec_report.ui.tajweed_c2_label.setText(str(row[70]))
                self.sec_report.ui.tajweed_ass_label.setText(str(row[71]))
                self.sec_report.ui.tajweed_att_label.setText(str(row[72]))
                self.sec_report.ui.tajweed_exam_label.setText(str(row[73]))
                self.sec_report.ui.tajweed_total_label.setText(str(row[74]))
                if row[74] < 40:
                ...
                self.sec_report.ui.agric_c1_label.setText(str(row[75]))
                self.sec_report.ui.agric_c2_label.setText(str(row[76]))
                self.sec_report.ui.agric_ass_label.setText(str(row[77]))
                self.sec_report.ui.agric_att_label.setText(str(row[78]))
                self.sec_report.ui.agric_exam_label.setText(str(row[79]))
                self.sec_report.ui.agric_total_label.setText(str(row[80]))
                if row[80] < 40:
                ...
                self.sec_report.ui.geography_c1_label.setText(str(row[81]))
                self.sec_report.ui.geography_c2_label.setText(str(row[82]))
                self.sec_report.ui.geography_ass_label.setText(str(row[83]))
                self.sec_report.ui.geography_att_label.setText(str(row[84]))
                self.sec_report.ui.geography_exam_label.setText(str(row[85]))
                self.sec_report.ui.geography_total_label.setText(str(row[86]))
                if row[86] < 40:
                    self.sec_report.ui.geography_grade_label.setText("F")
                    self.sec_report.ui.geography_remark_label.setText("Fail")
                elif row[86] >= 40 and row[86] < 46:
                    self.sec_report.ui.geography_grade_label.setText("E")
                    self.sec_report.ui.geography_remark_label.setText("Pass")
                elif row[86] >= 46 and row[86] < 50:
                    self.sec_report.ui.geography_grade_label.setText("D")
                    self.sec_report.ui.geography_remark_label.setText("Pass")
                elif row[86] >= 50 and row[86] < 60:
                    self.sec_report.ui.geography_grade_label.setText("C")
                    self.sec_report.ui.geography_remark_label.setText("Good")
                elif row[86] >= 60 and row[86] < 70:
                    self.sec_report.ui.geography_grade_label.setText("B")
                    self.sec_report.ui.geography_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.geography_grade_label.setText("A")
                    self.sec_report.ui.geography_remark_label.setText("Excellent")

                self.sec_report.ui.econs_c1_label.setText(str(row[87]))
                self.sec_report.ui.econs_c2_label.setText(str(row[88]))
                self.sec_report.ui.econs_ass_label.setText(str(row[89]))
                self.sec_report.ui.econs_att_label.setText(str(row[90]))
                self.sec_report.ui.econs_exam_label.setText(str(row[91]))
                self.sec_report.ui.econs_total_label.setText(str(row[92]))
                if row[92] < 40:
                    self.sec_report.ui.econs_grade_label.setText("F")
                    self.sec_report.ui.econs_remark_label.setText("Fail")
                elif row[92] >= 40 and row[92] < 46:
                    self.sec_report.ui.econs_grade_label.setText("E")
                    self.sec_report.ui.econs_remark_label.setText("Pass")
                elif row[92] >= 46 and row[92] < 50:
                    self.sec_report.ui.econs_grade_label.setText("D")
                    self.sec_report.ui.econs_remark_label.setText("Pass")
                elif row[92] >= 50 and row[92] < 60:
                    self.sec_report.ui.econs_grade_label.setText("C")
                    self.sec_report.ui.econs_remark_label.setText("Good")
                elif row[92] >= 60 and row[92] < 70:
                    self.sec_report.ui.econs_grade_label.setText("B")
                    self.sec_report.ui.econs_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.econs_grade_label.setText("A")
                    self.sec_report.ui.econs_remark_label.setText("Excellent")

                self.sec_report.ui.total_scores_label.setText(str(row[93]))
                self.sec_report.ui.avg_label.setText(str(row[94]))
                if row[94] < 40:
                ...
                positions = []
                cmd10 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY avg DESC"
                ...
                english_positions = []
                cmd11 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY eng_total DESC"
                cur.execute(cmd11, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    english_positions.append(row[1])
                for i in range(len(english_positions)):
                    if admission_no == english_positions[i]:
                        if i in range (10, len(english_positions), 100):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(english_positions), 100):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(english_positions), 100):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(english_positions), 10):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(english_positions), 10):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(english_positions), 10):
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.english_position_label.setText(str(i+1)+"th")

                math_positions = []
                cmd12 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY math_total DESC"
                cur.execute(cmd12, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    math_positions.append(row[1])
                for i in range(len(math_positions)):
                    if admission_no == math_positions[i]:
                        if i in range (10, len(math_positions), 100):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(math_positions), 100):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(math_positions), 100):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(math_positions), 10):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(math_positions), 10):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(math_positions), 10):
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.math_position_label.setText(str(i+1)+"th")

                civic_positions = []
                cmd14 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY civic_total DESC"
                cur.execute(cmd14, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    civic_positions.append(row[1])
                for i in range(len(civic_positions)):
                    if admission_no == civic_positions[i]:
                        if i in range (10, len(civic_positions), 100):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(civic_positions), 100):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(civic_positions), 100):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(civic_positions), 10):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(civic_positions), 10):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(civic_positions), 10):
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.civic_position_label.setText(str(i+1)+"th")

                computer_positions = []
                cmd15 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY computer_total DESC"
                cur.execute(cmd15, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    computer_positions.append(row[1])
                for i in range(len(computer_positions)):
                    if admission_no == computer_positions[i]:
                        if i in range (10, len(computer_positions), 100):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(computer_positions), 100):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(computer_positions), 100):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(computer_positions), 10):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(computer_positions), 10):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(computer_positions), 10):
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.computer_position_label.setText(str(i+1)+"th")

                biology_positions = []
                cmd16 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY biology_total DESC"
                cur.execute(cmd16, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    biology_positions.append(row[1])
                for i in range(len(biology_positions)):
                    if admission_no == biology_positions[i]:
                        if i in range (10, len(biology_positions), 100):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(biology_positions), 100):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(biology_positions), 100):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(biology_positions), 10):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(biology_positions), 10):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(biology_positions), 10):
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.biology_position_label.setText(str(i+1)+"th")

                chemistry_positions = []
                cmd17 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY chemistry_total DESC"
                cur.execute(cmd17, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    chemistry_positions.append(row[1])
                for i in range(len(chemistry_positions)):
                    if admission_no == chemistry_positions[i]:
                        if i in range (10, len(chemistry_positions), 100):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(chemistry_positions), 100):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(chemistry_positions), 100):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(chemistry_positions), 10):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(chemistry_positions), 10):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(chemistry_positions), 10):
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.chemistry_position_label.setText(str(i+1)+"th")

                further_positions = []
                cmd18 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY further_total DESC"
                cur.execute(cmd18, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    further_positions.append(row[1])
                for i in range(len(further_positions)):
                    if admission_no == further_positions[i]:
                        if i in range (10, len(further_positions), 100):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(further_positions), 100):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(further_positions), 100):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(further_positions), 10):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(further_positions), 10):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(further_positions), 10):
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.further_position_label.setText(str(i+1)+"th")

                physics_positions = []
                cmd19 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY physics_total DESC"
                cur.execute(cmd19, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    physics_positions.append(row[1])
                for i in range(len(physics_positions)):
                    if admission_no == physics_positions[i]:
                        if i in range (10, len(physics_positions), 100):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(physics_positions), 100):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(physics_positions), 100):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(physics_positions), 10):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(physics_positions), 10):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(physics_positions), 10):
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.physics_position_label.setText(str(i+1)+"th")

                qur_positions = []
                cmd20 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY qur_total DESC"
                cur.execute(cmd20, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    qur_positions.append(row[1])
                for i in range(len(qur_positions)):
                    if admission_no == qur_positions[i]:
                        if i in range (10, len(qur_positions), 100):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(qur_positions), 100):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(qur_positions), 100):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(qur_positions), 10):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(qur_positions), 10):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(qur_positions), 10):
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.qur_position_label.setText(str(i+1)+"th")

                arabic_positions = []
                cmd21 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY arabic_total DESC"
                cur.execute(cmd21, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    arabic_positions.append(row[1])
                for i in range(len(arabic_positions)):
                    if admission_no == arabic_positions[i]:
                        if i in range (10, len(arabic_positions), 100):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(arabic_positions), 100):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(arabic_positions), 100):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(arabic_positions), 10):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(arabic_positions), 10):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(arabic_positions), 10):
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.arabic_position_label.setText(str(i+1)+"th")

                tajweed_positions = []
                cmd22 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY tajweed_total DESC"
                cur.execute(cmd22, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    tajweed_positions.append(row[1])
                for i in range(len(tajweed_positions)):
                    if admission_no == tajweed_positions[i]:
                        if i in range (10, len(tajweed_positions), 100):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(tajweed_positions), 100):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(tajweed_positions), 100):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(tajweed_positions), 10):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(tajweed_positions), 10):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(tajweed_positions), 10):
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.tajweed_position_label.setText(str(i+1)+"th")

                agric_positions = []
                cmd23 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY agric_total DESC"
                cur.execute(cmd23, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    agric_positions.append(row[1])
                for i in range(len(agric_positions)):
                    if admission_no == agric_positions[i]:
                        if i in range (10, len(agric_positions), 100):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(agric_positions), 100):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(agric_positions), 100):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(agric_positions), 10):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(agric_positions), 10):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(agric_positions), 10):
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.agric_position_label.setText(str(i+1)+"th")

                geography_positions = []
                cmd25 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY geography_total DESC"
                cur.execute(cmd25, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    geography_positions.append(row[1])
                for i in range(len(geography_positions)):
                    if admission_no == geography_positions[i]:
                        if i in range (10, len(geography_positions), 100):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(geography_positions), 100):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(geography_positions), 100):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(geography_positions), 10):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(geography_positions), 10):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(geography_positions), 10):
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.geography_position_label.setText(str(i+1)+"th")

                irs_positions = []
                cmd27 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY irs_total DESC"
                cur.execute(cmd27, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    irs_positions.append(row[1])
                for i in range(len(irs_positions)):
                    if admission_no == irs_positions[i]:
                        if i in range (10, len(irs_positions), 100):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(irs_positions), 100):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(irs_positions), 100):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(irs_positions), 10):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(irs_positions), 10):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(irs_positions), 10):
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.irs_position_label.setText(str(i+1)+"th")

                econs_positions = []
                cmd27 = "SELECT * FROM t_sen_sec_scores_first WHERE score_class = ? ORDER BY econs_total DESC"
                cur.execute(cmd27, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    econs_positions.append(row[1])
                for i in range(len(econs_positions)):
                    if admission_no == econs_positions[i]:
                        if i in range (10, len(econs_positions), 100):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(econs_positions), 100):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(econs_positions), 100):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(econs_positions), 10):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(econs_positions), 10):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(econs_positions), 10):
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.econs_position_label.setText(str(i+1)+"th")
                ...
                cur.execute(cmd7)
                row = cur.fetchone()
                self.sec_report.ui.fees_label.setText(row[8])
...
class SenSecReport(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_SenSecReportForm()
        self.ui.setupUi(self)
...
class SecScoresRecord2(QWidget):
    def __init__(self):
        ...
        self.ui.qur_score_btn.clicked.connect(self.savephysics1Scores)
    ...
    def displaySpinVals(self):
        ...
        self.ui.physics1_c1_spin.setValue(0)
        self.ui.physics1_c2_spin.setValue(0)
        self.ui.physics1_ass_spin.setValue(0)
        self.ui.physics1_exam_spin.setValue(0)
        ...
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        try:
            cmd1 = "SELECT * FROM t_sen_sec_scores_second WHERE stud_no = ?"
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            ...
            if row != None and row[13] != None and row[14] != None and row[15] != None and row[16] != None:
                self.ui.physics1_c1_spin.setValue(row[13])
                self.ui.physics1_c2_spin.setValue(row[14])
                self.ui.physics1_ass_spin.setValue(row[15])
                self.ui.physics1_exam_spin.setValue(row[16])
    ...
    def saveQurScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_exam, qur_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_exam, qur_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, qur_c1 = ?, qur_c2 = ?, qur_ass = ?, qur_exam = ?, qur_total  = ? WHERE stud_no = ?"
    ...
    def saveIbadatScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, ibadat_c1, ibadat_c2, ibadat_ass, ibadat_exam, ibadat_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, ibadat_c1, ibadat_c2, ibadat_ass, ibadat_exam, ibadat_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, ibadat_c1 = ?, ibadat_c2 = ?, ibadat_ass = ?, ibadat_exam = ?, ibadat_total  = ? WHERE stud_no = ?"
    ...
    def savephysics1Scores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        physics1_c1 = self.ui.physics1_c1_spin.value()
        physics1_c2 = self.ui.physics1_c2_spin.value()
        physics1_ass = self.ui.physics1_ass_spin.value()
        physics1_exam = self.ui.physics1_exam_spin.value()
        physics1_total = physics1_c1 + physics1_c2 + physics1_ass + physics1_exam
        cmd1 = "SELECT * FROM t_sen_sec_scores_second WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, physics1_c1 = ?, physics1_c2 = ?, physics1_ass = ?, physics1_exam = ?, physics1_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total, stud_no,))
                con.commit()
        except Error:
             pass
        finally:
    ...
    def saveNahwuScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, nahwu_c1, nahwu_c2, nahwu_ass, nahwu_exam, nahwu_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, nahwu_c1, nahwu_c2, nahwu_ass, nahwu_exam, nahwu_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, nahwu_c1 = ?, nahwu_c2 = ?, nahwu_ass = ?, nahwu_exam = ?, nahwu_total  = ? WHERE stud_no = ?"
    ...
    def saveEnglishScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_exam, eng_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_exam, eng_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, eng_c1 = ?, eng_c2 = ?, eng_ass = ?, eng_exam = ?, eng_total  = ? WHERE stud_no = ?"
    ...
    def saveMathScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, math_c1, math_c2, math_ass, math_exam, math_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, math_c1, math_c2, math_ass, math_exam, math_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, math_c1 = ?, math_c2 = ?, math_ass = ?, math_exam = ?, math_total  = ? WHERE stud_no = ?"
    ...
    def saveBasScScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, bas_sc_c1, bas_sc_c2, bas_sc_ass, bas_sc_exam, bas_sc_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, bas_sc_c1, bas_sc_c2, bas_sc_ass, bas_sc_exam, bas_sc_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, bas_sc_c1 = ?, bas_sc_c2 = ?, bas_sc_ass = ?, bas_sc_exam = ?, bas_sc_total = ? WHERE stud_no = ?"
    ...
    def saveReligionScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, religion_c1, religion_c2, religion_ass, religion_exam, religion_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, religion_c1, religion_c2, religion_ass, religion_exam, religion_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, religion_c1 = ?, religion_c2 = ?, religion_ass = ?, religion_exam = ?, religion_total = ? WHERE stud_no = ?"
    ...
    def saveCivicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_exam, civic_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_exam, civic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, civic_c1 = ?, civic_c2 = ?, civic_ass = ?, civic_exam = ?, civic_total = ? WHERE stud_no = ?"
    ...
    def saveCcaScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, cca_c1, cca_c2, cca_ass, cca_exam, cca_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, cca_c1, cca_c2, cca_ass, cca_exam, cca_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, cca_c1 = ?, cca_c2 = ?, cca_ass = ?, cca_exam = ?, cca_total = ? WHERE stud_no = ?"
    ...
    def savePrevocScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, prevoc_c1, prevoc_c2, prevoc_ass, prevoc_exam, prevoc_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, prevoc_c1, prevoc_c2, prevoc_ass, prevoc_exam, prevoc_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, prevoc_c1 = ?, prevoc_c2 = ?, prevoc_ass = ?, prevoc_exam = ?, prevoc_total = ? WHERE stud_no = ?"
    ...
    def saveFrenchScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, french_c1, french_c2, french_ass, french_exam, french_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, french_c1, french_c2, french_ass, french_exam, french_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, french_c1 = ?, french_c2 = ?, french_ass = ?, french_exam = ?, french_total = ? WHERE stud_no = ?"
    ...
    def saveHausaScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_second(stud_no, score_class, hausa_c1, hausa_c2, hausa_ass, hausa_exam, hausa_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, hausa_c1, hausa_c2, hausa_ass, hausa_exam, hausa_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, score_class = ?, hausa_c1 = ?, hausa_c2 = ?, hausa_ass = ?, hausa_exam = ?, hausa_total = ? WHERE stud_no = ?"
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            ...
            try:
                ...
                cmd2 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
                ...
                cmd3 = "UPDATE t_sen_sec_scores_second SET stud_no = ?, all_total = ?, avg = ?, total_cum = ?, avg_cum = ?  WHERE stud_no = ?"
...
class SecScoresView2(QWidget):
    ...
    def displayClasses(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        query = cur.execute('SELECT * FROM t_sen_sec_scores_second ORDER BY score_class')
        self.ui.class_comboBox.clear()
        classes = ["Select a class"]
        rows = cur.fetchall()
        for row in rows:
    ...
    def listStudsScores(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        cmd = "SELECT * FROM t_sen_sec_scores_second ORDER BY stud_no"
        cur.execute(cmd)
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
            self.ui.tableWidget.insertRow(row_number)
    ...
    def listClass(self):
        ...
        cur = con.cursor()
        classes_combo = self.ui.class_comboBox.currentText()
        cmd = "SELECT * FROM t_sen_sec_scores_second WHERE score_class = ? ORDER BY stud_no"
        cur.execute(cmd, (classes_combo,))
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
            self.ui.tableWidget_2.insertRow(row_number)
    ...
    def deleteStud(self):
        ...
        if stud_no == "Select an admission number":
            ...
            cmd = "DELETE FROM t_sen_sec_scores_second WHERE stud_no = ?"
            buttonReply = QMessageBox.warning(self, 'Deleting student', "WARNING: Deleting will remove all the student's score records in the class. Do you still wish to continue?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
            if buttonReply == QMessageBox.Yes:
                cur.execute(cmd, (stud_no,))
                con.commit()
    ...
    def generateSecReport(self):
        ...
        if row == None:
            ...
            try:
                cmd3 = "SELECT * FROM t_sen_sec_scores_second WHERE stud_no = ?"
                cur.execute(cmd3, (admission_no,))
                row = cur.fetchone()
                ...
                self.sec_report2.ui.physics1_c1_label.setText(str(row[13]))
                self.sec_report2.ui.physics1_c2_label.setText(str(row[14]))
                self.sec_report2.ui.physics1_ass_label.setText(str(row[15]))
                self.sec_report2.ui.physics1_exam_label.setText(str(row[16]))
                self.sec_report2.ui.physics1_total_label.setText(str(row[17]))
                if row[17] < 40:
                    self.sec_report2.ui.physics1_grade_label.setText("F")
                    self.sec_report2.ui.physics1_remark_label.setText("Fail")
                elif row[17] >= 40 and row[17] < 50:
                    self.sec_report2.ui.physics1_grade_label.setText("D")
                    self.sec_report2.ui.physics1_remark_label.setText("Pass")
                elif row[17] >= 50 and row[17] < 60:
                    self.sec_report2.ui.physics1_grade_label.setText("C")
                    self.sec_report2.ui.physics1_remark_label.setText("Good")
                elif row[17] >= 60 and row[17] < 70:
                    self.sec_report2.ui.physics1_grade_label.setText("B")
                    self.sec_report2.ui.physics1_remark_label.setText("Very Good")
                else:
                    self.sec_report2.ui.physics1_grade_label.setText("A")
                    self.sec_report2.ui.physics1_remark_label.setText("Excellent")
                ...
                cmd9 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
                ...
                pixmap = QPixmap()
                pixmap.loadFromData(QByteArray.fromBase64(row[5]))
                self.sec_report2.ui.prin_sig_label.setPixmap(QPixmap(pixmap))
                ...
                cur.execute(cmd7)
                row = cur.fetchone()
                self.sec_report2.ui.fees_label.setText(row[8])
                cmd8 = "SELECT * FROM t_senior_users WHERE role = 'mgmt'"
                cur.execute(cmd8)
                row = cur.fetchone()
...
class SecScoresRecord3(QWidget):
    ...
    def displaySpinVals(self):
        ...
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        try:
            cmd1 = "SELECT * FROM t_sen_sec_scores_third WHERE stud_no = ?"
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row != None and row[3] != None and row[4] != None and row[5] != None and row[6] != None:
                self.ui.qur_c1_spin.setValue(row[3])
    ...
    def saveQurScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_exam, qur_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_exam, qur_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, qur_c1 = ?, qur_c2 = ?, qur_ass = ?, qur_exam = ?, qur_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_exam, qur_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveIbadatScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, ibadat_c1, ibadat_c2, ibadat_ass, ibadat_exam, ibadat_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, ibadat_c1, ibadat_c2, ibadat_ass, ibadat_exam, ibadat_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, ibadat_c1 = ?, ibadat_c2 = ?, ibadat_ass = ?, ibadat_exam = ?, ibadat_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, ibadat_c1, ibadat_c2, ibadat_ass, ibadat_exam, ibadat_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def savephysics1Scores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, physics1_c1 = ?, physics1_c2 = ?, physics1_ass = ?, physics1_exam = ?, physics1_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, physics1_c1, physics1_c2, physics1_ass, physics1_exam, physics1_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveNahwuScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, nahwu_c1, nahwu_c2, nahwu_ass, nahwu_exam, nahwu_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, nahwu_c1, nahwu_c2, nahwu_ass, nahwu_exam, nahwu_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, nahwu_c1 = ?, nahwu_c2 = ?, nahwu_ass = ?, nahwu_exam = ?, nahwu_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, nahwu_c1, nahwu_c2, nahwu_ass, nahwu_exam, nahwu_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveEnglishScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_exam, eng_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_exam, eng_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, eng_c1 = ?, eng_c2 = ?, eng_ass = ?, eng_exam = ?, eng_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_exam, eng_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveMathScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, math_c1, math_c2, math_ass, math_exam, math_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, math_c1, math_c2, math_ass, math_exam, math_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, math_c1 = ?, math_c2 = ?, math_ass = ?, math_exam = ?, math_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, math_c1, math_c2, math_ass, math_exam, math_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveBasScScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, bas_sc_c1, bas_sc_c2, bas_sc_ass, bas_sc_exam, bas_sc_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, bas_sc_c1, bas_sc_c2, bas_sc_ass, bas_sc_exam, bas_sc_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, bas_sc_c1 = ?, bas_sc_c2 = ?, bas_sc_ass = ?, bas_sc_exam = ?, bas_sc_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, bas_sc_c1, bas_sc_c2, bas_sc_ass, bas_sc_exam, bas_sc_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveReligionScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, religion_c1, religion_c2, religion_ass, religion_exam, religion_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, religion_c1, religion_c2, religion_ass, religion_exam, religion_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, religion_c1 = ?, religion_c2 = ?, religion_ass = ?, religion_exam = ?, religion_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, religion_c1, religion_c2, religion_ass, religion_exam, religion_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveCivicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_exam, civic_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_exam, civic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, civic_c1 = ?, civic_c2 = ?, civic_ass = ?, civic_exam = ?, civic_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_exam, civic_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveCcaScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, cca_c1, cca_c2, cca_ass, cca_exam, cca_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, cca_c1, cca_c2, cca_ass, cca_exam, cca_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, cca_c1 = ?, cca_c2 = ?, cca_ass = ?, cca_exam = ?, cca_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, cca_c1, cca_c2, cca_ass, cca_exam, cca_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def savePrevocScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, prevoc_c1, prevoc_c2, prevoc_ass, prevoc_exam, prevoc_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, prevoc_c1, prevoc_c2, prevoc_ass, prevoc_exam, prevoc_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, prevoc_c1 = ?, prevoc_c2 = ?, prevoc_ass = ?, prevoc_exam = ?, prevoc_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, prevoc_c1, prevoc_c2, prevoc_ass, prevoc_exam, prevoc_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveFrenchScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, french_c1, french_c2, french_ass, french_exam, french_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, french_c1, french_c2, french_ass, french_exam, french_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, french_c1 = ?, french_c2 = ?, french_ass = ?, french_exam = ?, french_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, french_c1, french_c2, french_ass, french_exam, french_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def saveHausaScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_sen_sec_scores_third(stud_no, score_class, hausa_c1, hausa_c2, hausa_ass, hausa_exam, hausa_total) VALUES(?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, hausa_c1, hausa_c2, hausa_ass, hausa_exam, hausa_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, score_class = ?, hausa_c1 = ?, hausa_c2 = ?, hausa_ass = ?, hausa_exam = ?, hausa_total = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, hausa_c1, hausa_c2, hausa_ass, hausa_exam, hausa_total, stud_no,))
                con.commit()
        except Error:
             pass
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            ...
            try:
                all_total = row[7] + row[12] + row[17] + row[22] + row[27] + row[32] + row[37] + row[42] + row[47] + row[52] + row[57] + row[62] + row[67]
                avg = round((all_total/1300)*100, 4)
                cmd0 = "SELECT * FROM t_sen_sec_scores_first WHERE stud_no = ?"
                ...
                cmd2 = "SELECT * FROM t_sen_sec_scores_second WHERE stud_no = ?"
                cur.execute(cmd2, (stud_no,))
                row = cur.fetchone()
                if row == None:
                ...
                cmd3 = "UPDATE t_sen_sec_scores_third SET stud_no = ?, all_total = ?, avg = ?, total_cum = ?, avg_cum = ?  WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, all_total, avg, total_cum, avg_cum, stud_no,))
                con.commit()
                QMessageBox.information(self, "Saving Score",  "Student's scores saved successfully", QMessageBox.Ok)
            except Error as e:
...
class SecScoresView3(QWidget):
    ...
    def displayClasses(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        query = cur.execute('SELECT * FROM t_sen_sec_scores_third ORDER BY score_class')
        self.ui.class_comboBox.clear()
        classes = ["Select a class"]
        rows = cur.fetchall()
        for row in rows:
    ...
    def listStudsScores(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        cmd = "SELECT * FROM t_sen_sec_scores_third ORDER BY stud_no"
        cur.execute(cmd)
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
            self.ui.tableWidget.insertRow(row_number)
    ...
    def listClass(self):
        ...
        cur = con.cursor()
        classes_combo = self.ui.class_comboBox.currentText()
        cmd = "SELECT * FROM t_sen_sec_scores_third WHERE score_class = ? ORDER BY stud_no"
        cur.execute(cmd, (classes_combo,))
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
            self.ui.tableWidget_2.insertRow(row_number)
    ...
    def deleteStud(self):
        ...
        if stud_no == "Select an admission number":
            ...
            cmd = "DELETE FROM t_sen_sec_scores_third WHERE stud_no = ?"
            buttonReply = QMessageBox.warning(self, 'Deleting student', "WARNING: Deleting will remove all the student's score records in the class. Do you still wish to continue?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
            if buttonReply == QMessageBox.Yes:
                cur.execute(cmd, (stud_no,))
                con.commit()
    ...
    def generateSecReport(self):
        ...
        if row == None:
            ...
            try:
                cmd3 = "SELECT * FROM t_sen_sec_scores_third WHERE stud_no = ?"
                cur.execute(cmd3, (admission_no,))
                row = cur.fetchone()
                ...
                self.sec_report3.ui.physics1_c1_label.setText(str(row[13]))
                self.sec_report3.ui.physics1_c2_label.setText(str(row[14]))
                self.sec_report3.ui.physics1_ass_label.setText(str(row[15]))
                self.sec_report3.ui.physics1_exam_label.setText(str(row[16]))
                self.sec_report3.ui.physics1_total_label.setText(str(row[17]))
                if row[17] < 40:
                    self.sec_report3.ui.physics1_grade_label.setText("F")
                    self.sec_report3.ui.physics1_remark_label.setText("Fail")
                elif row[17] >= 40 and row[17] < 50:
                    self.sec_report3.ui.physics1_grade_label.setText("D")
                    self.sec_report3.ui.physics1_remark_label.setText("Pass")
                elif row[17] >= 50 and row[17] < 60:
                    self.sec_report3.ui.physics1_grade_label.setText("C")
                    self.sec_report3.ui.physics1_remark_label.setText("Good")
                elif row[17] >= 60 and row[17] < 70:
                    self.sec_report3.ui.physics1_grade_label.setText("B")
                    self.sec_report3.ui.physics1_remark_label.setText("Very Good")
                else:
                    self.sec_report3.ui.physics1_grade_label.setText("A")
                    self.sec_report3.ui.physics1_remark_label.setText("Excellent")
                ...
                cmd10 = "SELECT * FROM t_sen_sec_scores_second WHERE stud_no = ?"
                ...
                positions = []
                cmd11 = "SELECT * FROM t_sen_sec_scores_third WHERE score_class = ? ORDER BY avg_cum DESC"
                cur.execute(cmd11, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    positions.append(row[1])
                ...
                pixmap = QPixmap()
                pixmap.loadFromData(QByteArray.fromBase64(row[5]))
                self.sec_report3.ui.prin_sig_label.setPixmap(QPixmap(pixmap))
                cmd6 = "SELECT * FROM t_senior_users WHERE role = 'mgmt'"
                cur.execute(cmd6)
                row = cur.fetchone()
