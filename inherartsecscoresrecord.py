...
class ArtSecScoresRecord(QWidget):
    def __init__(self):
        ...
        self.ui.qur_score_btn.clicked.connect(self.saveLitScores)
        ...
        self.ui.qur_score_btn.clicked.connect(self.saveGovtScores)
    ...
    def displaySpinVals(self):
        ...
        self.ui.lit_c1_spin.setValue(0)
        self.ui.lit_c2_spin.setValue(0)
        self.ui.lit_ass_spin.setValue(0)
        self.ui.lit_att_spin.setValue(0)
        self.ui.lit_exam_spin.setValue(0)
        ...
        self.ui.govt_c1_spin.setValue(0)
        self.ui.govt_c2_spin.setValue(0)
        self.ui.govt_ass_spin.setValue(0)
        self.ui.govt_att_spin.setValue(0)
        self.ui.govt_exam_spin.setValue(0)
        ...
        try:
            cmd1 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
            ...
            if row != None and row[15] != None and row[16] != None and row[17] != None and row[18] != None and row[19] != None:
                self.ui.lit_c1_spin.setValue(row[15])
                self.ui.lit_c2_spin.setValue(row[16])
                self.ui.lit_ass_spin.setValue(row[17])
                self.ui.lit_att_spin.setValue(row[18])
                self.ui.lit_exam_spin.setValue(row[19])
            ...
            if row != None and row[33] != None and row[34] != None and row[35] != None and row[36] != None and row[37] != None:
                self.ui.biology_c1_spin.setValue(row[33])
                self.ui.biology_c2_spin.setValue(row[34])
                self.ui.biology_ass_spin.setValue(row[35])
                self.ui.biology_att_spin.setValue(row[36])
                self.ui.biology_exam_spin.setValue(row[37])
            if row != None and row[39] != None and row[40] != None and row[41] != None and row[42] != None and row[43] != None:
                self.ui.qur_c1_spin.setValue(row[39])
                self.ui.qur_c2_spin.setValue(row[40])
                self.ui.qur_ass_spin.setValue(row[41])
                self.ui.qur_att_spin.setValue(row[42])
                self.ui.qur_exam_spin.setValue(row[43])
            if row != None and row[45] != None and row[46] != None and row[47] != None and row[48] != None and row[49] != None:
                self.ui.irs_c1_spin.setValue(row[45])
                self.ui.irs_c2_spin.setValue(row[46])
                self.ui.irs_ass_spin.setValue(row[47])
                self.ui.irs_att_spin.setValue(row[48])
                self.ui.irs_exam_spin.setValue(row[49])
            ...
            if row != None and row[57] != None and row[58] != None and row[59] != None and row[60] != None and row[61] != None:
                self.ui.tajweed_c1_spin.setValue(row[57])
                self.ui.tajweed_c2_spin.setValue(row[58])
                self.ui.tajweed_ass_spin.setValue(row[59])
                self.ui.tajweed_att_spin.setValue(row[60])
                self.ui.tajweed_exam_spin.setValue(row[61])
            ...
            if row != None and row[69] != None and row[70] != None and row[71] != None and row[72] != None and row[73] != None:
                self.ui.govt_c1_spin.setValue(row[69])
                self.ui.govt_c2_spin.setValue(row[70])
                self.ui.govt_ass_spin.setValue(row[71])
                self.ui.govt_att_spin.setValue(row[72])
                self.ui.govt_exam_spin.setValue(row[73])
            if row != None and row[75] != None and row[76] != None and row[77] != None and row[78] != None and row[79] != None:
                self.ui.geography_c1_spin.setValue(row[75])
                self.ui.geography_c2_spin.setValue(row[76])
                self.ui.geography_ass_spin.setValue(row[77])
                self.ui.geography_att_spin.setValue(row[78])
                self.ui.geography_exam_spin.setValue(row[79])
    ...
    def saveEnglishScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_att, eng_exam, eng_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, eng_c1, eng_c2, eng_ass, eng_att, eng_exam, eng_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, eng_c1 = ?, eng_c2 = ?, eng_ass = ?, eng_att = ?, eng_exam = ?, eng_total  = ? WHERE stud_no = ?"
    ...
    def saveMathScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, math_c1, math_c2, math_ass, math_att, math_exam, math_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, math_c1, math_c2, math_ass, math_att, math_exam, math_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, math_c1 = ?, math_c2 = ?, math_ass = ?, math_att = ?, math_exam = ?, math_total  = ? WHERE stud_no = ?"
    ...
    def saveLitScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        lit_c1 = self.ui.lit_c1_spin.value()
        lit_c2 = self.ui.lit_c2_spin.value()
        lit_ass = self.ui.lit_ass_spin.value()
        lit_att = self.ui.lit_att_spin.value()
        lit_exam = self.ui.lit_exam_spin.value()
        lit_total = lit_c1 + lit_c2 + lit_ass + lit_att + lit_exam
        cmd1 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, lit_c1, lit_c2, lit_ass, lit_att, lit_exam, lit_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, lit_c1, lit_c2, lit_ass, lit_att, lit_exam, lit_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, lit_c1 = ?, lit_c2 = ?, lit_ass = ?, lit_att = ?, lit_exam = ?, lit_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, lit_c1, lit_c2, lit_ass, lit_att, lit_exam, lit_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveCivicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_att, civic_exam, civic_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, civic_c1, civic_c2, civic_ass, civic_att, civic_exam, civic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, civic_c1 = ?, civic_c2 = ?, civic_ass = ?, civic_att = ?, civic_exam = ?, civic_total  = ? WHERE stud_no = ?"
    ...
    def saveComputerScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, computer_c1, computer_c2, computer_ass, computer_att, computer_exam, computer_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, computer_c1, computer_c2, computer_ass, computer_att, computer_exam, computer_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, computer_c1 = ?, computer_c2 = ?, computer_ass = ?, computer_att = ?, computer_exam = ?, computer_total  = ? WHERE stud_no = ?"
    ...
    def saveBiologyScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, biology_c1, biology_c2, biology_ass, biology_att, biology_exam, biology_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, biology_c1, biology_c2, biology_ass, biology_att, biology_exam, biology_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, biology_c1 = ?, biology_c2 = ?, biology_ass = ?, biology_att = ?, biology_exam = ?, biology_total  = ? WHERE stud_no = ?"
    ...
    def saveQurScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_att, qur_exam, qur_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, qur_c1, qur_c2, qur_ass, qur_att, qur_exam, qur_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, qur_c1 = ?, qur_c2 = ?, qur_ass = ?, qur_att = ?, qur_exam = ?, qur_total  = ? WHERE stud_no = ?"
    ...
    def saveIrsScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, irs_c1, irs_c2, irs_ass, irs_att, irs_exam, irs_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, irs_c1, irs_c2, irs_ass, irs_att, irs_exam, irs_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, irs_c1 = ?, irs_c2 = ?, irs_ass = ?, irs_att = ?, irs_exam = ?, irs_total  = ? WHERE stud_no = ?"
    ...
    def saveArabicScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, arabic_c1, arabic_c2, arabic_ass, arabic_att, arabic_exam, arabic_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, arabic_c1, arabic_c2, arabic_ass, arabic_att, arabic_exam, arabic_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, arabic_c1 = ?, arabic_c2 = ?, arabic_ass = ?, arabic_att = ?, arabic_exam = ?, arabic_total  = ? WHERE stud_no = ?"
    ...
    def saveTajweedScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, tajweed_c1, tajweed_c2, tajweed_ass, tajweed_att, tajweed_exam, tajweed_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, tajweed_c1, tajweed_c2, tajweed_ass, tajweed_att, tajweed_exam, tajweed_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, tajweed_c1 = ?, tajweed_c2 = ?, tajweed_ass = ?, tajweed_att = ?, tajweed_exam = ?, tajweed_total  = ? WHERE stud_no = ?"
    ...
    def saveAgricScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, agric_c1, agric_c2, agric_ass, agric_att, agric_exam, agric_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, agric_c1, agric_c2, agric_ass, agric_att, agric_exam, agric_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, agric_c1 = ?, agric_c2 = ?, agric_ass = ?, agric_att = ?, agric_exam = ?, agric_total  = ? WHERE stud_no = ?"
    ...
    def saveGovtScores(self):
        con = sqlite3.connect("futuredb.db")
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        score_class = self.ui.class_comboBox.currentText()
        stud_no = self.ui.stud_adm_no_comboBox.currentText()
        govt_c1 = self.ui.govt_c1_spin.value()
        govt_c2 = self.ui.govt_c2_spin.value()
        govt_ass = self.ui.govt_ass_spin.value()
        govt_att = self.ui.govt_att_spin.value()
        govt_exam = self.ui.govt_exam_spin.value()
        govt_total = govt_c1 + govt_c2 + govt_ass + govt_att + govt_exam
        cmd1 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
        try:
            cur.execute(cmd1, (stud_no,))
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, govt_c1, govt_c2, govt_ass, govt_att, govt_exam, govt_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, govt_c1, govt_c2, govt_ass, govt_att, govt_exam, govt_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, govt_c1 = ?, govt_c2 = ?, govt_ass = ?, govt_att = ?, govt_exam = ?, govt_total  = ? WHERE stud_no = ?"
                cur.execute(cmd3, (stud_no, score_class, govt_c1, govt_c2, govt_ass, govt_att, govt_exam, govt_total, stud_no,))
                con.commit()
        except Error:
            pass
        finally:
    ...
    def saveGeographyScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, geography_c1, geography_c2, geography_ass, geography_att, geography_exam, geography_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                ...
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, geography_c1 = ?, geography_c2 = ?, geography_ass = ?, geography_att = ?, geography_exam = ?, geography_total  = ? WHERE stud_no = ?"
    ...
    def saveHistoryScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, history_c1, history_c2, history_ass, history_att, history_exam, history_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, history_c1, history_c2, history_ass, history_att, history_exam, history_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, history_c1 = ?, history_c2 = ?, history_ass = ?, history_att = ?, history_exam = ?, history_total  = ? WHERE stud_no = ?"
    ...
    def saveEconsScores(self):
        ...
        try:
            ...
            row = cur.fetchone()
            if row == None:
                cmd2 = "INSERT INTO t_art_sec_scores_first(stud_no, score_class, econs_c1, econs_c2, econs_ass, econs_att, econs_exam, econs_total) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
                cur.execute(cmd2, (stud_no, score_class, econs_c1, econs_c2, econs_ass, econs_att, econs_exam, econs_total,))
                con.commit()
            else:
                cmd3 = "UPDATE t_art_sec_scores_first SET stud_no = ?, score_class = ?, econs_c1 = ?, econs_c2 = ?, econs_ass = ?, econs_att = ?, econs_exam = ?, econs_total  = ? WHERE stud_no = ?"
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            ...
            try:
                ...
                cmd2 = "UPDATE t_art_sec_scores_first SET stud_no = ?, all_total = ?, avg = ?  WHERE stud_no = ?"
...
class ArtSecScoresView(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_ArtSecScoreForm()
        self.ui.setupUi(self)
        self.sec_report = ArtSecReport()
        self.displayClasses()
    ...
    def displayClasses(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        query = cur.execute('SELECT * FROM t_art_sec_scores_first ORDER BY score_class')
        self.ui.class_comboBox.clear()
        classes = ["Select a class"]
        rows = cur.fetchall()
        for row in rows:
    ...
    def listStudsScores(self):
        ...
        con.execute("PRAGMA foreign_keys = 1")
        cur = con.cursor()
        cmd = "SELECT * FROM t_art_sec_scores_first ORDER BY stud_no"
        cur.execute(cmd)
        rows = cur.fetchall()
    ...
    def listClass(self):
        ...
        cur = con.cursor()
        classes_combo = self.ui.class_comboBox.currentText()
        cmd = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY stud_no"
        cur.execute(cmd, (classes_combo,))
        rows = cur.fetchall()
        for row_number, row_data in enumerate(rows):
    ...
    def deleteStud(self):
        ...
        if stud_no == "Select an admission number":
            ...
            cmd = "DELETE FROM t_art_sec_scores_first WHERE stud_no = ?"
    ...
    def generateSecReport(self):
        ...
        if row == None:
            ...
            try:
                cmd3 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
                ...
                self.sec_report.ui.lit_c1_label.setText(str(row[15]))
                self.sec_report.ui.lit_c2_label.setText(str(row[16]))
                self.sec_report.ui.lit_ass_label.setText(str(row[17]))
                self.sec_report.ui.lit_att_label.setText(str(row[18]))
                self.sec_report.ui.lit_exam_label.setText(str(row[19]))
                self.sec_report.ui.lit_total_label.setText(str(row[20]))
                if row[20] < 40:
                    self.sec_report.ui.lit_grade_label.setText("F")
                    self.sec_report.ui.lit_remark_label.setText("Fail")
                elif row[20] >= 40 and row[20] < 46:
                    self.sec_report.ui.lit_grade_label.setText("E")
                    self.sec_report.ui.lit_remark_label.setText("Pass")
                elif row[20] >= 46 and row[20] < 50:
                    self.sec_report.ui.lit_grade_label.setText("D")
                    self.sec_report.ui.lit_remark_label.setText("Pass")
                elif row[20] >= 50 and row[20] < 60:
                    self.sec_report.ui.lit_grade_label.setText("C")
                    self.sec_report.ui.lit_remark_label.setText("Good")
                elif row[20] >= 60 and row[20] < 70:
                    self.sec_report.ui.lit_grade_label.setText("B")
                    self.sec_report.ui.lit_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.lit_grade_label.setText("A")
                    self.sec_report.ui.lit_remark_label.setText("Excellent")
                ...
                self.sec_report.ui.biology_c1_label.setText(str(row[33]))
                self.sec_report.ui.biology_c2_label.setText(str(row[34]))
                self.sec_report.ui.biology_ass_label.setText(str(row[35]))
                self.sec_report.ui.biology_att_label.setText(str(row[36]))
                self.sec_report.ui.biology_exam_label.setText(str(row[37]))
                self.sec_report.ui.biology_total_label.setText(str(row[38]))
                if row[38] < 40:
                ...
                self.sec_report.ui.qur_c1_label.setText(str(row[39]))
                self.sec_report.ui.qur_c2_label.setText(str(row[40]))
                self.sec_report.ui.qur_ass_label.setText(str(row[41]))
                self.sec_report.ui.qur_att_label.setText(str(row[42]))
                self.sec_report.ui.qur_exam_label.setText(str(row[43]))
                self.sec_report.ui.qur_total_label.setText(str(row[44]))
                if row[44] < 40:
                ...
                self.sec_report.ui.irs_c1_label.setText(str(row[45]))
                self.sec_report.ui.irs_c2_label.setText(str(row[46]))
                self.sec_report.ui.irs_ass_label.setText(str(row[47]))
                self.sec_report.ui.irs_att_label.setText(str(row[48]))
                self.sec_report.ui.irs_exam_label.setText(str(row[49]))
                self.sec_report.ui.irs_total_label.setText(str(row[50]))
                if row[50] < 40:
                ...
                self.sec_report.ui.tajweed_c1_label.setText(str(row[57]))
                self.sec_report.ui.tajweed_c2_label.setText(str(row[58]))
                self.sec_report.ui.tajweed_ass_label.setText(str(row[59]))
                self.sec_report.ui.tajweed_att_label.setText(str(row[60]))
                self.sec_report.ui.tajweed_exam_label.setText(str(row[61]))
                self.sec_report.ui.tajweed_total_label.setText(str(row[62]))
                if row[62] < 40:
                ...
                self.sec_report.ui.agric_c1_label.setText(str(row[63]))
                self.sec_report.ui.agric_c2_label.setText(str(row[64]))
                self.sec_report.ui.agric_ass_label.setText(str(row[65]))
                self.sec_report.ui.agric_att_label.setText(str(row[66]))
                self.sec_report.ui.agric_exam_label.setText(str(row[67]))
                self.sec_report.ui.agric_total_label.setText(str(row[68]))
                if row[68] < 40:
                ...
                self.sec_report.ui.govt_c1_label.setText(str(row[69]))
                self.sec_report.ui.govt_c2_label.setText(str(row[70]))
                self.sec_report.ui.govt_ass_label.setText(str(row[71]))
                self.sec_report.ui.govt_att_label.setText(str(row[72]))
                self.sec_report.ui.govt_exam_label.setText(str(row[73]))
                self.sec_report.ui.govt_total_label.setText(str(row[74]))
                if row[74] < 40:
                    self.sec_report.ui.govt_grade_label.setText("F")
                    self.sec_report.ui.govt_remark_label.setText("Fail")
                elif row[74] >= 40 and row[74] < 46:
                    self.sec_report.ui.govt_grade_label.setText("E")
                    self.sec_report.ui.govt_remark_label.setText("Pass")
                elif row[74] >= 46 and row[74] < 50:
                    self.sec_report.ui.govt_grade_label.setText("D")
                    self.sec_report.ui.govt_remark_label.setText("Pass")
                elif row[74] >= 50 and row[74] < 60:
                    self.sec_report.ui.govt_grade_label.setText("C")
                    self.sec_report.ui.govt_remark_label.setText("Good")
                elif row[74] >= 60 and row[74] < 70:
                    self.sec_report.ui.govt_grade_label.setText("B")
                    self.sec_report.ui.govt_remark_label.setText("Very Good")
                else:
                    self.sec_report.ui.govt_grade_label.setText("A")
                    self.sec_report.ui.govt_remark_label.setText("Excellent")

                self.sec_report.ui.geography_c1_label.setText(str(row[75]))
                self.sec_report.ui.geography_c2_label.setText(str(row[76]))
                self.sec_report.ui.geography_ass_label.setText(str(row[77]))
                self.sec_report.ui.geography_att_label.setText(str(row[78]))
                self.sec_report.ui.geography_exam_label.setText(str(row[79]))
                self.sec_report.ui.geography_total_label.setText(str(row[80]))
                if row[80] < 40:
                ...
                self.sec_report.ui.history_c1_label.setText(str(row[81]))
                self.sec_report.ui.history_c2_label.setText(str(row[82]))
                self.sec_report.ui.history_ass_label.setText(str(row[83]))
                self.sec_report.ui.history_att_label.setText(str(row[84]))
                self.sec_report.ui.history_exam_label.setText(str(row[85]))
                self.sec_report.ui.history_total_label.setText(str(row[86]))
                if row[86] < 40:
                ...
                positions = []
                cmd10 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY avg DESC"
                ...
                english_positions = []
                cmd11 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY eng_total DESC"
                ...
                math_positions = []
                cmd12 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY math_total DESC"
                ...
                lit_positions = []
                cmd13 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY lit_total DESC"
                cur.execute(cmd13, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    lit_positions.append(row[1])
                for i in range(len(lit_positions)):
                    if admission_no == lit_positions[i]:
                        if i in range (10, len(lit_positions), 100):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(lit_positions), 100):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(lit_positions), 100):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(lit_positions), 10):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(lit_positions), 10):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(lit_positions), 10):
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.lit_position_label.setText(str(i+1)+"th")

                civic_positions = []
                cmd14 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY civic_total DESC"
                ...
                computer_positions = []
                cmd15 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY computer_total DESC"
                ...
                biology_positions = []
                cmd16 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY biology_total DESC"
                ...
                qur_positions = []
                cmd20 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY qur_total DESC"
                ...
                arabic_positions = []
                cmd21 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY arabic_total DESC"
                ...
                tajweed_positions = []
                cmd22 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY tajweed_total DESC"
                ...
                agric_positions = []
                cmd23 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY agric_total DESC"
                ...
                govt_positions = []
                cmd24 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY govt_total DESC"
                cur.execute(cmd24, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    govt_positions.append(row[1])
                for i in range(len(govt_positions)):
                    if admission_no == govt_positions[i]:
                        if i in range (10, len(govt_positions), 100):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(govt_positions), 100):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(govt_positions), 100):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(govt_positions), 10):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(govt_positions), 10):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(govt_positions), 10):
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.govt_position_label.setText(str(i+1)+"th")

                geography_positions = []
                cmd25 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY geography_total DESC"
                ...
                irs_positions = []
                cmd27 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY irs_total DESC"
                ...
                history_positions = []
                cmd26 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY history_total DESC"
                cur.execute(cmd26, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
                    history_positions.append(row[1])
                for i in range(len(history_positions)):
                    if admission_no == history_positions[i]:
                        if i in range (10, len(history_positions), 100):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"th")
                        elif i in range (11, len(history_positions), 100):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"th")
                        elif i in range (12, len(history_positions), 100):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"th")
                        elif i in range (0, len(history_positions), 10):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"st")
                        elif i in range (1, len(history_positions), 10):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"nd")
                        elif i in range (2, len(history_positions), 10):
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"rd")
                        else:
                            self.sec_report.ui.history_position_label.setText(str(i+1)+"th")

                econs_positions = []
                cmd26 = "SELECT * FROM t_art_sec_scores_first WHERE score_class = ? ORDER BY econs_total DESC"
                cur.execute(cmd26, (classes_combo,))
                rows = cur.fetchall()
                for row in rows:
...
class ArtSecReport(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_ArtSecReportForm()
        self.ui.setupUi(self)
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            ...
            try:
                ...
                cmd2 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
    ...
    def generateSecReport(self):
        ...
        if row == None:
            ...
            try:
                ...
                cmd9 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
    ...
    def computeTotAvg(self):
        ...
        if row == None:
            ...
            try:
                all_total = row[7] + row[12] + row[17] + row[22] + row[27] + row[32] + row[37] + row[42] + row[47] + row[52] + row[57] + row[62] + row[67]
                avg = round((all_total/1300)*100, 4)
                cmd0 = "SELECT * FROM t_art_sec_scores_first WHERE stud_no = ?"
